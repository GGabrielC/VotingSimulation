...
class MaxStandardDeviationProportionalWeightedSumWins(VotingSystem):
    def __init__(self, alpha=0):
        self.alpha = alpha
        super().__init__(name="MaxStandardDeviationProportionalWeightedSumWins<α={}>".format(self.alpha))
